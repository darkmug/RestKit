Pod::Spec.new do |s|
  ...
  s.author       =  { 'Blake Watters' => 'blakewatters@gmail.com', 'Dennis Bachmann' => 'dennis@bmssi.com.br' }
  s.source       =  { :git => 'https://github.com/Darkmug/RestKit.git', :tag => "v#{s.version}-bmssi" }
